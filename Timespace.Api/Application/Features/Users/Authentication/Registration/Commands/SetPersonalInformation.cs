...
using Timespace.Api.Application.Features.Users.Authentication.Registration.Common;
...
public static class SetPersonalInformation {
    ...
    public class CommandValidator : AbstractValidator<Command>
    {
        public CommandValidator()
        {
            ...
            RuleFor(x => x.Body.Deep).NotNull();
            RuleFor(x => x.Body.Deep.SomeProperty).NotEmpty().MaximumLength(80);
        }
    }
}