...
public class NewTypescriptApiClientGenerator : IExternalSourceGenerator
{
    private readonly ILogger<NewTypescriptApiClientGenerator> _logger;
    ...
    public NewTypescriptApiClientGenerator(Compilation compilation, IApiDescriptionGroupCollectionProvider apiExplorer, ILogger<NewTypescriptApiClientGenerator> logger, IOptions<ExternalSourceGenerationSettings> options)
    {
